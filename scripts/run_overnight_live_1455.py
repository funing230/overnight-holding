...
def main() -> None:
    ...
    manifest = {
        ...
        "scorer_review_scores": args.agent_review_scores,
        "selector_review_scores": args.heavy_review_scores,
        "scorer_review_scores": args.light_review_scores,
    ...
    result = run_live_inference(
        ...
        selector_review_scores_path=args.heavy_review_scores,
        scorer_review_scores_path=args.light_review_scores,
        live_weight=args.live_weight,
        agent_weight=args.agent_weight,
        heavy_weight=args.heavy_weight,
        light_weight=args.light_weight,
