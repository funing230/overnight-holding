...
from dataflows.overnight_live_heavy_review_provider import (
...
def test_multi_stage_fusion_adds_social_bonus_score(tmp_path):
    ...
    fused = apply_multi_stage_review_fusion(scored, heavy_path, light_path, social_hot_features_path=social_path, theme_hot_features_path=theme_path)
    by_code = fused.set_index("ts_code")
